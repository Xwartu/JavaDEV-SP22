...
public class PollTracking
{
    ...
    public static void main(String[] args)
    {
        ...
        // Add hotdog and hamburger
        categoryList.add(0, "Hot Dog");
        categoryList.add(1, "Hamburger");

        // Create the main frame
        JFrame mainFrame = new JFrame("Poll: Hot dogs or Hamburgers?");
        ...
        // Set the dimensions
        mainFrame.setPreferredSize(new Dimension(1024, 780));
        ...
        JLabel pollOtherLabel = new JLabel("Other");
